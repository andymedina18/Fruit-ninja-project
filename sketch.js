...
function preload(){
  ...
  cocinaImg = loadImage("Fondo cocina.jpg");
...
function draw() {
  //Se puede agregar la variable de la imagen directo en el fondo y se ajusta por sí sola o:
  background(cocinaImg);
